...
import { Search, User, XCircle, X, Loader2, Loader, Locate, LocationEdit, LocateIcon, MapPin } from 'lucide-react'
                            ...
                            <div>
                                {location?.data?.map((e) => (
                                    <div
                                        ...
                                        key={e.locationId}
                                    >
                                        <div className="flex items-center cursor-pointer gap-[10px]">
                                            <div className="p-2 border-1 border-gray-300 rounded-full">
                                                <MapPin />
                                            </div>
                                            <div>
