				...
				<div className=' rounded-2xl p-[20px] gap-y-[5vh] flex flex-col md:flex-row items-center justify-between border border-gray-300'>
					<aside className='flex items-center gap-[10px]'>
						...
						<div>
							<div>
								<h1
									className='font-bold text-[#1E293B] text-[22px] w-[140px] lg:w-[300px]
							...
							<div>
								<p className='font-normal text-[#64748B] text-[20px] w-[100px] overflow-hidden text-ellipsis whitespace-nowrap lg:w-[300px] '>
									{user.firstName}
								</p>
								{user.lastName && (
