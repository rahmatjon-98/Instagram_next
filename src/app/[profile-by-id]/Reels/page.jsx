      ...
      <div className="grid grid-cols-3 gap-4">
        {loading ? (
          ...
          Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="relative md:w-[310px] h-[190px] w-[113px] md:h-[414px] overflow-hidden rounded-[2px]"
            >
              <Skeleton
                variant="rectangular"
                animation="wave"
          ...
          posts.data
            ...
            .map((post, i) => {
              const video = post?.images?.find((media) =>
                media.endsWith(".mp4")
              );
                    ...
                    <div className="border-t fixed bottom-0 bg-[#272727] h-[120px] z-10 lg:w-[47%] w-[100%] lg:p-0 p-[20px] mt-[300px] pt-[10px]">
                      <div className="flex justify-between mb-2 pt-[10px]">
                        ...
                        >
                          <Bookmark
                            fill={
                              postById.data?.postFavorite ? "white" : "none"
                            }
                            size={24}
                            color="#ffffff"
                          />
