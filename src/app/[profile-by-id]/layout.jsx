...
const ProfileById = ({ children }) => {
  ...
  const video = posts?.data?.map((e) =>
    e?.images?.some((media) => media.endsWith(".mp4"))
  );
                ...
                <>
                  <div className="flex gap-[10px] items-center">
                    ...
                    <button
                      ...
                      className={`text-[12px] ${
                        theme == "dark"
                          ? "bg-[#25292e] text-white"
                          : "bg-[#F3F4F6]"
                      }  font-medium py-[7px] px-4 rounded-lg`}
                    >
                  ...
                  <button
                    ...
                    className={`${
                      theme == "dark"
                        ? "bg-[#25292e] text-white"
                        : "bg-[#F3F4F6]"
                    } text-[12px] md:text-[14px] font-medium py-[7px] px-4 rounded-lg`}
                  >
                    <UserPlusIcon
                      size={18}
              ...
              <>
                <p
                  className={`text-center text-[12px] ${
                    theme == "dark" ? "text-[#fff]" : "text-[#1E293B]"
                  } block md:flex gap-2`}
                >
                  {user?.postCount}
                  <span
                ...
                <p
                  ...
                  className={`text-center text-[12px] ${
                    theme == "dark" ? "text-[#fff]" : "text-[#1E293B]"
                  } block cursor-pointer md:flex gap-2`}
                >
                  {user?.subscribersCount}
                  <span
                    className={`text-center text-[12px] ${
      ...
      <div className="flex  mt-10 justify-around">
        <button
          ...
          style={{
            ...
            borderTop:
              pathname === `/${profileId}` ? "2px solid #2563EB" : "none",
          }}
