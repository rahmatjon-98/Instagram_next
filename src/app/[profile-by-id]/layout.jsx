				...
				<div className='flex flex-col gap-[20px]'>
					<div className='flex items-center gap-[40px]'>
						...
						<div className='flex items-center gap-[10px]'>
							<button
								className='bg-[#f0f2f5] text-[12px] md:text-[14px] font-medium py-[7px] px-4 rounded-lg'
							>
								Follow
							</button>
					...
					<div className='flex items-center gap-[20px]'>
						...
						<p className='text-[#1E293B] block cursor-pointer md:flex'>
							{user?.subscriptionsCount}
							<span className='text-[#64748B] block md:flex md:ml-[2px]'>following</span>
						</p>
					</div>
					<div className='flex'>
