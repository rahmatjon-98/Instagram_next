...
export default function Main() {
  ...
  return (
    <div className="flex w-full items-start">
              ...
              <div className="lg:flex w-full gap-[20px]">
                ...
                <div className=" lg:p-[20px] ">
                  <div className="lg:p-0 p-[20px]">
                    ...
                    <div className="overflow-y-scroll max-h-[23vh] lg:max-h-[53vh] space-y-3 hidscrol">
      ...
      {comments && <Commentory UserId={Idx} setComments={setComments} />}
      <div className="md:px-[11%] px-[10px] pt-[40px] w-[100%] md:w-[70%]">
        <div
          ...
          className="pb-[20px] border-b border-b-[#E2E8F0] flex  overflow-x-scroll hidscrol whitespace w-full select-none"
        >
          {(isLoading &&
                          ...
                          <>
                            {e.images.map((image, i3) => {
                              return (
                                <div
                                  key={i3}
                                  className="w-[100%] bg-black lg:max-h-[80vh]"
                                >
                                  <Image
                                    key={i3}
